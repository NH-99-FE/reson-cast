...
export const videoViewSelections = createSelectSchema(videoViews)
export const videoViewInsert = createInsertSchema(videoViews)
export const videoViewUpdate = createUpdateSchema(videoViews)
